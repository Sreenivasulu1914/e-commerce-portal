...
# sk_test_51QkgcEC4jul9TxeyUqx9asajB3S1xzcCW3TIoFcSVcplhduCU1G2AOrZEIQaeGUVBkde2JnC1qx8147RLkv9syNx00EaeoMf7n
# stripe.api_key = os.environ.get('STRIPE_SECRET_KEY', 'sk_test_51QkgcEC4jul9TxeyUqx9asajB3S1xzcCW3TIoFcSVcplhduCU1G2AOrZEIQaeGUVBkde2JnC1qx8147RLkv9syNx00EaeoMf7n')  # Replace with your actual Stripe secret key
...
def login():
    if request.method == 'POST':
        ...
        # Verify hCaptcha
        secret_key = 'ES_cbbc36b5577144fc99e380d107a62918'  # Replace with your actual Secret Key
        payload = {
            'secret': secret_key,
